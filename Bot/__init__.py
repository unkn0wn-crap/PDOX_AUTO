...
OWNER_ID = "6908541951" #OWNER ID
MAIN_CHANNEL = int(environ.get('MAIN_CHANNEL', "-1002386259040"))#YOUR MAIN CHANNEL ID
ARCHIVE_CHANNEL = int(environ.get('ARCHIVE_CHANNEL', "-1002386259040"))#YOUR ARCHIVE CHANNEL
